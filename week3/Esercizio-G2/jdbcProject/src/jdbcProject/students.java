...
public class students {
	...
	public students( String name, String lastname, String gender, LocalDate birthdate, Integer avg,
	...
	public String toString() {
		return "students [id=" + id + ", name=" + name + ", lastname=" + lastname + ", gender=" + gender
